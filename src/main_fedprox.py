...
class CommunicationTrackingStrategy(FedProx):
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(args.save_dir, f"{args.N}-{args.p}-{args.E}-{args.alpha}-{args.B}", f"fedprox-{args.balance_params}-{args.seed}")
